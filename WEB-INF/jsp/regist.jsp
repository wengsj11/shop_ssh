...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/shop_ssh/WebRoot/WEB-INF/jsp/regist.jsp">
	<%@include file="header.jsp" %>
	<div class="container register" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/shop_ssh/WebRoot/WEB-INF/jsp/regist.jsp">
		<div class="span24">
			<div class="wrap">
						...
						<table>
							<tbody>
								<tr>
									...
									<td><span><s:fielderror fieldName="username" /></span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><span><s:fielderror fieldName="email" /></span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											title="点击更换验证码" onclick="changeImg()" /></span></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
