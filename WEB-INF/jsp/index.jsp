...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/shop_ssh/WebRoot/WEB-INF/jsp/index.jsp">

	<%@include file="header.jsp" %>

	<div class="container index" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/shop_ssh/WebRoot/WEB-INF/jsp/index.jsp">
			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
				...
				<ul class="tabContent" style="display: block;">
					<s:iterator value="hotList">
						...
						<li><a  href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property value="pid"/>"><img
