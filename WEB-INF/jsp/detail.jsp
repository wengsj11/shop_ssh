...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/shop_ssh/WebRoot/WEB-INF/jsp/detail.jsp">

	<%@include file="header.jsp"%>
	<form action="${pageContext.request.contextPath}/cart_addCart.action" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/shop_ssh/WebRoot/WEB-INF/jsp/detail.jsp">
		<input name="pid" type="hidden" value="<s:property value="model.pid" />" />
			...
			<div class="span18 last">
				...
				<div class="info">
					<dl>
						<dt>亿家价:</dt>
						<dd>
							<strong>￥：<s:property value="model.shop_price" /></strong> 参 考
							价：
							<del>
								￥
